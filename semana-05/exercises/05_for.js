...
recorrer dicho array utilizando un bucle for de JavaScript para mostrar 
una alerta utilizando cada una de las palabras.*/

console.log('-Exercise 5.a:');

var array = ["guitarra", "bajo", "bateria", "piano", "violin"];
...
for(i=0; i<array.length; i++) {
    var instrumento = array[i];
    var primeraLetra = instrumento.substring(0,1); 
    var restoDePalabras = instrumento.substring(1);
    alert(primeraLetra.toUpperCase() + restoDePalabras); 
}
